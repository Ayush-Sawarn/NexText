...
from TextSummariser.entity import (DataIngestionConfig,DataValidationConfig,DataTransformationConfig,ModelTrainerConfig,ModelEvaluationConfig)
...
class ConfigurationManager:
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        ...
        model_trainer_config = ModelTrainerConfig(
            ...
            per_device_eval_batch_size=int(params.per_device_train_batch_size),
